...
bucket_name = 'e-commerce_data_stunner007'
gcp_conn_id = 'google_cloud_default'
dataset_id = 'ecommerce'
bq_project_id = 'gifted-object-444508-n6'  # The GCP project ID for BigQuery


@dag(
    dag_id='gcs_to_bigquery_autodetect',
...
def gcs_to_bigquery_pipeline():
    ...
    logger.info(f"BigQuery dataset creation task initialized for dataset ID: {dataset_id}")
